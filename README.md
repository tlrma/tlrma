...
- 임베디드 시스템과 AI를 결합한 프로젝트에 관심이 있습니다.
- 문제를 직접 구현하고, 성능 저하 원인을 분석해 개선하는 과정을 중요하게 생각합니다.
- 센서 기반 제어, computer vision, ROS, 웹 서비스 구현 경험을 쌓아 왔습니다.
...
## Featured Projects
  ...
  <tr>
    <td width="100%">
      ...
      <p>
        ATmega128 기반으로 헬멧 착용, 음주 여부, 양손 핸들링을 확인한 뒤에만 작동하는 안전 중심 킥보드 시스템
      </p>
      <p>
        <img src="https://img.shields.io/badge/ATmega128-333333?style=flat-square" />
        <img src="https://img.shields.io/badge/MQ3%20Sensor-FF6B6B?style=flat-square" />
        <img src="https://img.shields.io/badge/Touch%20Sensor-4CAF50?style=flat-square" />
        <img src="https://img.shields.io/badge/UART-0078D4?style=flat-square" />
      </p>
    </td>
  </tr>
  ...
  <tr>
    <td width="100%">
      <h3>🚁 타겟 드론 Following 시스템</h3>
      <p>
        전면 카메라 영상에서 타겟 드론을 감지하고 bounding box 기반으로 위치를 조정하는 ROS 기반 드론 제어 시스템
      </p>
      <p>
        <img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white" />
        <img src="https://img.shields.io/badge/ROS-22314E?style=flat-square" />
        <img src="https://img.shields.io/badge/Object%20Detection-FF9800?style=flat-square" />
        <img src="https://img.shields.io/badge/Jetson%20Nano-76B900?style=flat-square" />
      </p>
    </td>
  </tr>
  ...
  <tr>
    <td width="100%">
      <h3>🎵 Facial Emotion Detect 노래 추천 웹사이트</h3>
      <p>
        표정 인식과 사용자 식별을 결합해 감정에 맞는 음악을 추천하는 웹 서비스
      </p>
      <p>
        <img src="https://img.shields.io/badge/ResNet18-5C6BC0?style=flat-square" />
        <img src="https://img.shields.io/badge/K--NN-009688?style=flat-square" />
